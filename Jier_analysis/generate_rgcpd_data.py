...
prec_1 = data['0..1..sst']
prec_2 = data['0..2..sst']
target_region.to_csv(os.path.join(current_analysis_path, 'target.csv'), header=['dates','values'])
# prec_1.to_csv(os.path.join(current_analysis_path, 'first_sst_prec.csv'), header=['dates','values'])
# prec_2.to_csv(os.path.join(current_analysis_path, 'second_sst_prec.csv'), header=['dates','values'])